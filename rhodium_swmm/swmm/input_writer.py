...
def write_dict_to_swmm_input_file(swmm_input_dict, swmm_input_file_path="swmm.inp"):

    with open(swmm_input_file_path, 'w') as swmm_input_file:
        write(swmm_input_dict, swmm_input_file)

def write_dict_to_swmm_input_string(swmm_input_dict):
    with io.StringIO() as swmm_input_file:
        write(swmm_input_dict, swmm_input_file)
        return swmm_input_file.getvalue()
